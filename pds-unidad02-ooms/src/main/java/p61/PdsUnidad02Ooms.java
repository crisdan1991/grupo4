...
import p61.bridge.InscripcionPosgrado;
import p61.bridge.InscripcionPresencialImpl;
import p61.bridge.InscripcionTecnologia;
...
public class PdsUnidad02Ooms {
    ...
    public static void bridge(){
        ...
        var inscripcion1 = new InscripcionTecnologia(new InscripcionPresencialImpl());
        inscripcion1.setNivelEstudio(NivelEstudio.TECNOLOGIA);
